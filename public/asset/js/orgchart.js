...
(OrgChart._defaultConfig = function (t) {
        ...
        if (null != i) {
            ...
            if (null != a) {
                ...
                OrgChart.events.publish("ripple", [this, b]),
                    ...
                    m.setAttribute(
                        "width",
                        b.ripple.rect ? b.ripple.rect.width : i.w
                    ),
                    m.setAttribute(
                        "height",
                        b.ripple.rect ? b.ripple.rect.height : i.h
                    ),
            ...
            switch (
                ...
                case OrgChart.orientation.right:
                    b =
                        firstRoot.y -
                        C / 2 +
                        OrgChart.manager._getNodeWidth(firstRoot, this.config) /
                            2;
            }
        var v = [O, b, m, C];
        a[0] !== v[0] || a[1] !== v[1]
    ...
    (OrgChart.SEARCH_PLACEHOLDER = "Cari... ketik ? untuk melihat bantuan."),
    ...
    (OrgChart.icon.search = function (t, e, r) {
        return (
            ...
            '" height="' +
            e +
            '" xmlns="http://www.w3.org/2000/svg" data-svg-id="1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 485.213 485.213"><path fill="' +
            r +
            ...
            this._draw(!1, OrgChart.action.exporting, i, function (i, a) {
                ...
                if ("svg" == t.ext)
                    if (e) e(t, n.innerHTML);
                        ...
                        if (
                            !1 ===
                            (h = OrgChart.events.publish("exportend", [r, s]))
                        )
                            return !1;
        ...
        if (!OrgChart.EXPORT_PAGES_CUT_NODES && "fit" == t.scale) {
            ...
            for (
                ...
                y < Object.keys(i.bordersByRootIdAndLevel[b[x]]).length &&
                    ((v = i.bordersByRootIdAndLevel[b[x]]),
                    (y = Object.keys(v).length));
            for (var _ = 0, w = 0; ; ) {
                for (w = _; !(y <= _); ) {
        ...
        var I = { x: d.x, y: d.y },
                    ...
                    if (d.left || d.right || d.up || d.down) {
                        ...
                        if (
                            ...
                            for (; null != o && o != h; ) {
                                if (
                                    o.hasAttribute &&
                                    o.hasAttribute(OrgChart.attr.node_id)
                                ) {
                                    var B = o.getAttribute(
                                        OrgChart.attr.node_id
                                    );
                                    if (
                                        i._gragStartedId &&
            ...
            N = function (e) {
                ...
                if (
                    ...
                    if (
                        !1 ===
                        (o = OrgChart.events.publish("drop", [
                            i,
                            c[0].id,
                            n.id,
                            f[0],
                    ...
                    if (t._dragEventFired) {
                        ...
                        if (i.config.movable && !1 !== o)
                            if (
                                i.config.movable == OrgChart.movable.detachTree
                            ) {
                                var d = OrgChart._getTransform(
                                    i.getNodeElement(s.id)
                                );
    ...
    (OrgChart.prototype._dragDropHandler = function (t, e, r) {
        ...
        var m = function (t, e) {
                ...
                if (d) {
                    ...
                    if (C.left || C.right || C.up || C.down) {
                        ...
                        if (
                            ...
                            !1 === OrgChart.events.publish("drag", [s, k, e]) &&
                                O(),
                                (t._dragEventFired = !0);
                        f.setAttribute(
                            "transform",
            ...
            O = function (e) {
                ...
                if (
                    !1 ===
                    OrgChart.events.publish("drop", [s, n.id, i.id, f, e])
                )
                    return (
                        m(o, l),
                        h.removeChild(f),
    ...
    (OrgChart.searchUI.prototype.init = function (t) {
        ...
        var d = function () {
                var t = e.instance.element.querySelectorAll(
                        "[data-search-item-id]"
                    ),
                    r = e.instance.element.querySelector(
                        '[data-selected="yes"]'
                    );
                null == r && t.length > 0
        ...
        if (null == this.instance.config.searchFields) {
            ...
            for (var t = 0; t < this.instance.response.allFields.length; t++) {
                ...
                "tags" == e ||
                    ...
                    (-1 == this._searchFields.indexOf(e) &&
    ...
    (OrgChart.searchUI.prototype._search = function () {
        ...
        for (
            var i = this.instance.element.querySelectorAll(
                    "[data-search-item-id]"
                ),
                a = 0;
            a < i.length;
            ...
            i[a].addEventListener("click", function () {
                if (this.hasAttribute("data-search-item-id")) {
                    ...
                    if (e.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
                        var r = OrgChart.events.publish("searchclick", [
                                e.instance,
                                t,
                            ]),
                            i = OrgChart.events.publish("searchclick", [
                        ...
                        if ((!1 === r && (i = !1), !1 !== i)) {
                            ...
                            var a = e.instance.element.querySelector(
                                '[data-selected="yes"]'
                            );
                ...
                if (c) {
                    ...
                    if (!u) {
                        if (!OrgChart.isNEU(c.pid))
                            (ft = (O = l[c.pid]).childrenIds.indexOf(c.id)) >
                                -1 && O.childrenIds.splice(ft, 1);
                        s.push(c);
                    }
                }
            }
            ...
            for (var b = l[a.id]; b; ) {
                if (
                    ...
                    a.options.parentState ===
                        OrgChart.COLLAPSE_PARENT_NEIGHBORS && b)
                )
                ...
                (H = C.children[v]).isAssistant
                    ...
                    ? -1 != H.tags.indexOf("partner") && N % 2
                        ? ((H.isPartner = 2),
                          ...
                          N++)
                        : H.parentPartner
                        ? (E[H.parentPartner.id] ||
                              (E[H.parentPartner.id] = []),
                          E[H.parentPartner.id].push(H.id))
                        : I.push(H.id)
                    ...
                    for (var gt = 0; gt < et.layouts.length; gt++) {
                        ...
                        if (pt.subLevels) {
                            for (v = 0; v < pt.childrenIds.length; v++) {
                                ...
                                -1 != (ft = O.children.indexOf(H)) &&
                                    O.children.splice(ft, 1),
                                    (H.parent = ut),
                                    ut.children.push(H);
                            }
                            O = ut;
                        ...
                        if (
                            ...
                            "dynamic" == pt.layoutGridColumns &&
                                (pt.layoutGridColumns =
                                    OrgChart._getDynamicGridCoulumns(
                                    ...
                                    ((H =
                                        ...
                                        bt ||
                                            (Ct / 2 - 1 == v &&
                                                ...
                                                OrgChart.manager._initDinamicNode(
                                                    Ot,
                                                    O.lcn
                                                ),
                                                (Ot.parent = l[mt]),
    ...
    (OrgChart.manager._getResponse = function (
        ...
        if (
            ...
            if (x - 2 * i.padding >= a - o)
                ...
                switch (
                    ((w =
                        f.x - x / 2 + OrgChart.manager._getNodeWidth(f, i) / 2),
                    i.orientation)
                ) {
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (w = -(x / 2 - (o - a) / 2)) < i.padding - x &&
                            (w = i.padding - x);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.bottom_left:
        ...
        if (OrgChart.manager._isVisible(t, r, i, a)) {
            ...
            if (null != d && null != d.x && null != d.y)
                if (d.x != t.x || d.y != t.y)
                    (n &&
                        n.dragNodeIdList &&
                        -1 != n.dragNodeIdList.indexOf(t.id)) ||
                        (h[0].push(t.id),
    ...
    (OrgChart.templates.base = {
        ...
        svg: '<svg xmlns="http://www.w3.org/2000/svg" data-svg-id="2" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>',
        ...
        menuButton:
            '<div style="position:absolute;right:0px;top:{p}px; width:30px;height:50px;cursor:pointer;" ' +
            OrgChart.attr.control_export_menu +
            '=""><hr style="background-color: #7A7A7A; height: 3px; border: none; margin: 5px 5px;"><hr style="background-color: #7A7A7A; height: 3px; border: none; margin: 5px 5px;"><hr style="background-color: #7A7A7A; height: 3px; border: none; margin: 5px 5px;"></div>',
    ...
    (OrgChart.templates.ana = {
        ...
        ripple: { radius: 0, color: "#e6e6e6", rect: null },
        expandCollapseSize: 30,
        svg: '<svg xmlns="http://www.w3.org/2000/svg" data-svg-id="3" xmlns:xlink="http://www.w3.org/1999/xlink"  style="display:block; height:100vh" width="1000" height="800" viewBox="-300 -90 1000 1400">{content}</svg>',
    ...
    (OrgChart.templates.rony.svg =
        '<svg xmlns="http://www.w3.org/2000/svg" data-svg-id="4" xmlns:xlink="http://www.w3.org/1999/xlink" style="background-color:#E8E8E8;display:block;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>'),
    ...
    (OrgChart.templates.luba.svg =
        '<svg xmlns="http://www.w3.org/2000/svg" data-svg-id="5" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;background-color: #2E2E2E;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>'),
    ...
    (OrgChart.ui = {
        ...
        link: function (t, e, r, i, a, n, o) {
                        ...
                        ? ((m.ppnodes[b.id] = b.parentPartner),
                          ...
                          1 == b.parentPartner.isPartner
                              ? (-1 == m.rightIds.indexOf(b.parentPartner.id) &&
                                ...
                                (m.indexes[b.id] = m.rightIds.indexOf(
                                    b.parentPartner.id
                                )),
                              ...
                              : 2 == b.parentPartner.isPartner &&
                                ...
                                (m.indexes[b.id] = m.leftIds.indexOf(
                                    b.parentPartner.id
                                )),
                                (m.lastLeft = b)))
                        : b.isPartner ||
            ...
            for (C = 0; C < t.children.length; C++) {
                    ...
                    switch (s.orientation) {
                        ...
                        case OrgChart.orientation.top_left:
                            var _ =
                                1 == b.layout
                                    ? void 0
                                    : v.minY - (v.minY - f.maxY) / 2;
                            y = OrgChart.ui._linkTopToBottom(
                                b.parentPartner,
                                b,
                                h,
                                g,
                        ...
                        case OrgChart.orientation.bottom_left:
                            _ =
                                1 == b.layout
                                    ? void 0
                                    : v.maxY - (v.maxY - f.minY) / 2;
                            y = OrgChart.ui._linkBottomToTop(
                                b.parentPartner,
                                b,
                                h,
                                g,
                        ...
                        case OrgChart.orientation.right_top:
                            _ =
                                1 == b.layout
                                    ? void 0
                                    : v.maxX - (v.maxX - f.minX) / 2;
                            y = OrgChart.ui._linkRightToLeft(
                                b.parentPartner,
                                b,
                                h,
                                g,
                ...
                var S = OrgChart.ui._draggableLinkPath(
                    e,
                    t,
                    b,
                    y,
                        ...
                        (L.value = B),
                            ...
                            !1 !== OrgChart.events.publish("label", [e, L]) &&
                                (OrgChart.isNEU(L.value) ||
                                    ...
                                    (E += L.element.replace("{val}", L.value)));
                    }
                }
                if ("" != E) {
                    var U = y.x,
        ...
        _draggableLinkPath: function (t, e, r, i, a, n) {
            ...
            if (OrgChart._isMoved(r) && !OrgChart._isMoved(e)) {
                ...
                return OrgChart.roundPathCorners(
                    o,
                    OrgChart.LINK_ROUNDED_CORNERS,
                    !1
                );
        ...
        if (-1 != c.indexOf("multiline")) {
            ...
            if (null != p.innerHTML) (S = p.innerHTML), (p.innerHTML = "");
                ...
                for (_ = p.childNodes.length - 1; _ >= 0; _--)
                    (I =
                        XMLSerializer().serializeToString(p.childNodes[_]) + I),
            ...
            for (var d = 1; d < t.length; d++) {
                ...
                if (
                    ...
                    var u,
                        ...
                        O = o(p);
                    r
                        ? ((u = a(C, c.origPoint || m, e)),
                          (f = a(C, p.origPoint || O, e)))
                        : ((u = i(C, m, e)), (f = i(C, O, e))),
                        n(g, u),
                        (g.origPoint = C),
                        l.push(g);
    ...
    (OrgChart.prototype._clink = function (t, e) {
        for (var r = "", i = 0; i < this.config.clinks.length; i++) {
            ...
            function _(t, e, r) {
                ...
                return (
                    (o =
                        (o / (Math.sqrt(i * i + n * n) * r)) *
                        OrgChart.clinkCurve(a)),
    ...
    (OrgChart.prototype._slinks = function (t, e) {
        ...
        function n(e, n, o) {
                    ...
                    if (
                        (b.id == n.id
                            ...
                            : OrgChart._intersects(b, f, g) &&
                              ((f = OrgChart._addPoint(b, s, g, f, d)),
                              (O = !0)),
                        b.id != n.id)
                    ) {
                        for (; v; ) {
                            ...
                            OrgChart._intersects(v, f, g) &&
                                ((f = OrgChart._addPoint(v, s, g, f, d)),
                                (O = !0)),
                                (v = v.leftNeighbor);
                        }
                        for (; y; ) {
                            ...
                            OrgChart._intersects(y, f, g) &&
                                ((f = OrgChart._addPoint(y, s, g, f, d)),
                                (O = !0)),
                                (y = y.rightNeighbor);
                        }
                    }
            ...
            var N = OrgChart.roundPathCorners(
                s,
                OrgChart.LINK_ROUNDED_CORNERS,
                !1
            );
            ...
            if (!1 !== OrgChart.events.publish("change", [this, e])) {
                ...
                e.undoStepsCount > 0
                    ? (r.classList.add("boc-ur-clickable"),
                      (r.querySelector(".boc-undo-i").innerHTML =
                          e.undoStepsCount),
                      (r.querySelector(".boc-undo-i").style.display =
                          "inline-block"))
                    : (r.classList.remove("boc-ur-clickable"),
                      (r.querySelector(".boc-undo-i").style.display = "none")),
                    e.redoStepsCount > 0
                        ? (i.classList.add("boc-ur-clickable"),
                          (i.querySelector(".boc-redo-i").innerHTML =
                              e.redoStepsCount),
                          (i.querySelector(".boc-redo-i").style.display =
                              "inline-block"))
    ...
    (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
        ...
        for (p = n.length - 1; p >= 0; p--)
            for (c = 0; c < n.length; c++)
                c < p &&
                    n[c].start + n[c].length > n[p].start &&
                    n.splice(p, 1);
        var b = e;
        for (p = n.length - 1; p >= 0; p--)
    ...
    (OrgChart.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            if ("all" == this.instance.config.filterBy)
                for (
                    var e = OrgChart.manager.getAllFields(this.instance.config),
                        r = 0;
                    r < e.length;
                    r++
                ) {
