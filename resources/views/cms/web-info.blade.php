                                ...
                                <div class="upload-container">
                                    <div class="upload-container-in">
                                        <div class="border-container-in">
                                            ...
                                            <input type="file" id="file-upload" data-index-input-file="0" name="logo" 
                                                class="input-file input-sm" >
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="appointment-form default-form">  
                        <div class="form-group">
                            ...
                            <textarea name="desc" id="wysiwyg-editor-desc" class="wysiwyg-editor">{{$selected['desc']['description']}}</textarea>
                        </div> 
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div>
                                    ...
                                    @endphp
                                    <div id="data-schedule-wrap" data-count="{{sizeof($schedule)}}">
                                    @for($i=0;$i<sizeof($schedule);$i++)
                                        <div class="row" id="schedule-item-{{$i}}">
                                            <div class="form-group col-md-8">
                                                <input type="text" name="schedule" value="{{$schedule[$i]->label}}">
                                            </div>
                                    ...
                                    <div class="upload-container">
                                        <div class="upload-container-in">
                                            <div class="border-container-in">
                                                ...
                                                <input type="file" id="file-upload" data-index-input-file="slide-{{$slider_count}}" name="slider[]['img_main']" class="input-file input-sm" >
                                                <p class="mb-2"><small>Drag dan drop file, atau <a href="#" id="file-browser">cari disini</a>.</small></p>
                                                <textarea class="textarea-compact" placeholder="Judul" name="slider[]['title']">{{$item['label']}}</textarea>
                                                <textarea class="textarea-compact" placeholder="Sub judul atas" name="slider[]['subtitle_top']">{{$item['value']}}</textarea>
                                                <textarea class="textarea-compact" placeholder="Sub judul bawah" name="slider[]['subtitle_bottom']">{{$item['description']}}</textarea>
                                                <input type="text" placeholder="Link tombol" name="slider[]['button_link']" value="{{$item['value2']}}">
                                                <input type="text" placeholder="ID" name="slider[]['id']" value="{{$item['id']}}" hidden>
                                    ...
                                    <div class="upload-container">
                                        <div class="upload-container-in">
                                            <div class="border-container-in">
                                                ...
                                                <input type="file" id="file-upload" data-index-input-file="related-link-{{$related_link_count}}" name="related_link[]['img_main']" class="input-file input-sm" >
                                                <p class="mb-2"><small>Drag dan drop file, atau <a href="#" id="file-browser">cari disini</a>.</small></p>
                                                <textarea class="textarea-compact" placeholder="Nama" name="related_link[]['title']">{{$item['label']}}</textarea>
                                                <input type="text" placeholder="Link" name="related_link[]['button_link']" value="{{$item['value2']}}">
                                                <input type="text" placeholder="ID" name="related_link[]['id']" value="{{$item['id']}}" hidden>
                                                <span class="text-muted smaller">* isi, hanya jika, ingin bagian tersebut tampil</span>
                                            </div>
                                        </div>
                                    </div>
